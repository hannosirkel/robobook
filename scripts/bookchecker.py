...
def evaluate_account_vat(
    *,
    ...
    for line in action_line_items(action):
        ...
        vat_amount_hint = abs(decimal_value(line.get("vat_amount_hint")))  # noqa: F841
...
def evaluate_bank_statement_completeness(
    ...
    *,
    ...
    for key, (_source_path, record) in physical_records.items():
        ...
        actual_total = sum((item["amount"] for item in items), Decimal("0"))  # noqa: FURB157
    ...
    for line in action_line_items(action):
        ...
        if not isinstance(proof, dict) or set(proof) != proof_fields:
            ...
            try:
                ...
                line_quantity = proof_quantity = Decimal("0")  # noqa: FURB157
        ...
        seen: set[str] = set()
        contributor_total = Decimal("0")  # noqa: FURB157
        for contributor in contributors:
            ...
            try:
                ...
                quantity = Decimal("0")  # noqa: FURB157
            if quantity <= 0:
...
def manual_financial_dependency_errors(
    ...
    try:
        ...
        physical_amount = Decimal("0")  # noqa: FURB157
    ...
    if not isinstance(split_parts, list):
        ...
        signed_total = Decimal("0")  # noqa: FURB157
